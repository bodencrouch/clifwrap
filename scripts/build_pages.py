...
<header class="hero">
  ...
  <h1>clifwrap</h1>
  <p>Transparent account failover, quota-aware scheduling, and wrapper-managed auth for CLIs such as SearchCLI and ScrapeCLI.</p>
  <div class="grid">{''.join(reports)}<a class="card" href="https://github.com/bodencrouch/clifwrap"><strong>GitHub</strong><span>Source repository and releases.</span></a></div>
</header>
<h2>Documentation</h2>
